...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.incomes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="photo">{{ trans('cruds.income.fields.photo') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.income.fields.photo_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    init: function () {
@if(isset($income) && $income->photo)
      var file = {!! json_encode($income->photo) !!}
