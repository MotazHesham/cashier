                ...
                <div class="col">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>{{ number_format($expensesTotal + $stockTotal, 2) }}</td>
                        </tr>
                ...
                <div class="col">
                    <table class="table table-bordered table-striped">
                        <tr style="border-color: red;border-width: 2px;border-style: ridge;">
                            ...
                            <th>{{ number_format($expensesTotal + $stockTotal, 2) }}</th>
                        </tr>
                        @foreach ($expensesSummary as $inc)
                            <tr>
                                <th>
                                    {{ $inc['name'] }}
                                    @if ($inc['details'] ?? '')
                                        <button type="button" class="btn btn-info btn-xs text-center"
                                            onclick="showDetailsModal()">أظهار التفاصيل</button>
                                    @endif
                                </th>
                                <td>{{ number_format($inc['amount'], 2) }}</td>
                            </tr>
