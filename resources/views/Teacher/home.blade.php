                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('teacher.send_order') }}" method="Post" id="store_form">
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading" role="tab" id="heading-student-{{ $student->id }}">
                                                            <h4 class="panel-title">
                                                                <div class="row">
                                                                    <a class="collapsed text-center" type="button" data-toggle="collapse"
                                                                        data-target="#collapse-student-{{ $student->id }}" aria-expanded="false"
                                                                        aria-controls="collapse-student-{{ $student->id }}">
                                                                        {{ $student->user->name ?? '' }}
                                                                    </a>
                                                                </div>
                                                            </h4>
                                                        </div>
                                                        <div id="collapse-student-{{ $student->id }}" class="collapse" aria-labelledby="heading-student-{{ $student->id }}" data-parent="#accordion">  <div class="panel-body">
                            ...
                            <button type="submit" class="btn btn-warning btn-lg btn-block text-white">أرسال
                                الطلب</button>
                        </form>
                    </div>
                </div>
