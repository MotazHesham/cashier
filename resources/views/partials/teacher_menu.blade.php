<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        <li class="c-sidebar-nav-item">
            <a href="{{ route("teacher.home") }}" class="c-sidebar-nav-link">
        ...
        <li class="c-sidebar-nav-item">
            <a href="{{ route("teacher.orders.index") }}" class="c-sidebar-nav-link {{ request()->is("teacher/orders") || request()->is("teacher/orders/*") ? "c-active" : "" }}">
