<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('cashier_mode_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.cashier-modes.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/cashier-modes") || request()->is("admin/cashier-modes/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('voucher_code_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.voucher-codes.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/voucher-codes") || request()->is("admin/voucher-codes/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-credit-card c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.voucherCode.title') }}
                </a>
            </li>
        @endcan
